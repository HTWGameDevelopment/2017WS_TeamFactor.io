data:extend  {
  {
  ...
  },
   {
    ...
    name = "cookingEquipment", -- The name of the ROW
  ...
  },
  {
    ...
    group = "food", --The item-group this subgroup belongs too
    order = "c", --The order of the row from top to bottom, row "b" would be above row "c"
  },
  {
    type = "item-subgroup", --C Row in the group
    name = "cookedfood", -- The name of the ROW
    group = "food", --The item-group this subgroup belongs too
    order = "d", --The order of the row from top to bottom, row "c" would be above row "d"
  },  
}
